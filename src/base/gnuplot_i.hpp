...
class GnuplotHLException : public std::runtime_error
{
    public:
        GnuplotHLException(const std::string &msg) : std::runtime_error(msg){}
};
...
class GnuplotHL
{
    ...
    public:
		...
		// ----------------------------------------------------------------------------
        /// \brief optional function: set GnuplotHL path manual
        ...
        GnuplotHL(const std::string &style = "points");

        /// plot a single std::vector at one go
        GnuplotHL(const std::vector<double> &x,
    ...
    /// send a command to gnuplot
        GnuplotHL& cmd(const std::string &cmdstr);
	// ---------------------------------------------------------------------------------
	...
	// ---------------------------------------------------------------------------------
    inline GnuplotHL& operator<<(const std::string &cmdstr){
        cmd(cmdstr);
        return(*this);
    }
    ...
    GnuplotHL& showonscreen(); // window output is set by default (win/x11/aqua)

    /// saves a gnuplot session to a postscript file, filename without extension
    GnuplotHL& savetops(const std::string &filename = "gnuplot_output");
    ...
    GnuplotHL& set_style(const std::string &stylestr = "points");
    ...
    GnuplotHL& set_smooth(const std::string &stylestr = "csplines");
    ...
    // ----------------------------------------------------------------------
    inline GnuplotHL& unset_smooth(){ smooth = ""; return *this;}; 


    /// scales the size of the points used in plots
    GnuplotHL& set_pointsize(const double pointsize = 1.0);

    /// turns grid on/off
    inline GnuplotHL& set_grid()	{cmd("set grid");return *this;};
    /// grid is not set by default	
    inline GnuplotHL& unset_grid(){cmd("unset grid");return *this;}; 
    ...
    // -----------------------------------------------
    inline GnuplotHL& set_multiplot(){cmd("set multiplot") ;return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------
    inline GnuplotHL& unset_multiplot(){cmd("unset multiplot");return *this;};
    


    /// set sampling rate of functions, or for interpolating data
    GnuplotHL& set_samples(const int samples = 100);
    /// set isoline density (grid) for plotting functions as surfaces (for 3d plots)
    GnuplotHL& set_isosamples(const int isolines = 10);
    ...
    /// \return <-- reference to the gnuplot object
    // --------------------------------------------------------------------------
    GnuplotHL& set_hidden3d(){cmd("set hidden3d");return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // ---------------------------------------------------------------------------
    inline GnuplotHL& unset_hidden3d(){cmd("unset hidden3d"); return *this;}; 

    /// enables/disables contour drawing for surfaces (for 3d plot)
    ///  base, surface, both
    GnuplotHL& set_contour(const std::string &position = "base");
    // --------------------------------------------------------------------------
    ...
    /// \return <-- reference to the gnuplot object
    // ------------------------------------------------------------------
    inline GnuplotHL& unset_contour(){cmd("unset contour");return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // ------------------------------------------------------------------
    inline GnuplotHL& set_surface(){cmd("set surface");return *this;}; 
    ...
    /// \return <-- reference to the gnuplot object
    // ------------------------------------------------------------------
    inline GnuplotHL& unset_surface(){cmd("unset surface"); return *this;}


    /// switches legend on/off
    /// position: inside/outside, left/center/right, top/center/bottom, nobox/box
    GnuplotHL& set_legend(const std::string &position = "default"); 
    ...
    /// \return <-- reference to the gnuplot object
    // ------------------------------------------------------------------
    inline GnuplotHL& unset_legend(){cmd("unset key"); return *this;}
    ...
    /// \return <-- reference to the gnuplot object
    // ----------------------------------------------------------------------- 
    inline GnuplotHL& set_title(const std::string &title = "")
    {
        std::string cmdstr;
        cmdstr = "set title \"";
        cmdstr+=title;
    ...
    /// \return <-- reference to the gnuplot object
    // ---------------------------------------------------------------------------------
    inline GnuplotHL& unset_title(){this->set_title();return *this;}


    /// set x axis label
    GnuplotHL& set_ylabel(const std::string &label = "x");
    /// set y axis label
    GnuplotHL& set_xlabel(const std::string &label = "y");
    /// set z axis label
    GnuplotHL& set_zlabel(const std::string &label = "z");

    /// set axis - ranges
    GnuplotHL& set_xrange(const double iFrom,
                        const double iTo);
    /// set y-axis - ranges
    GnuplotHL& set_yrange(const double iFrom,
                        const double iTo);
    /// set z-axis - ranges
    GnuplotHL& set_zrange(const double iFrom,
                        const double iTo);
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------
    inline GnuplotHL& set_xautoscale(){cmd("set xrange restore");cmd("set autoscale x");return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------
    inline GnuplotHL& set_yautoscale(){cmd("set yrange restore");cmd("set autoscale y");return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------	
    inline GnuplotHL& unset_xlogscale(){cmd("unset logscale x"); return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------	
    inline GnuplotHL& unset_ylogscale(){cmd("unset logscale y"); return *this;};
    ...
    /// \return <-- reference to the gnuplot object
    // -----------------------------------------------		
    inline GnuplotHL& unset_zlogscale(){cmd("unset logscale z"); return *this;};


    /// set palette range (autoscale by default)
    GnuplotHL& set_cbrange(const double iFrom, const double iTo);
    ...
    ///   from file
    GnuplotHL& plotfile_x(const std::string &filename,
                        const unsigned int column = 1,
                        const std::string &title = "");
    ///   from std::vector
    template<typename X>
    GnuplotHL& plot_x(const X& x, const std::string &title = "");


    /// plot x,y pairs: x y
    ///   from file
    GnuplotHL& plotfile_xy(const std::string &filename,
                         const unsigned int column_x = 1,
                         const unsigned int column_y = 2,
                         const std::string &title = "");
    ///   from data
    template<typename X, typename Y>
    GnuplotHL& plot_xy(const X& x, const Y& y, const std::string &title = "");


    /// plot x,y pairs with dy errorbars: x y dy
    ///   from file
    GnuplotHL& plotfile_xy_err(const std::string &filename,
                             const unsigned int column_x  = 1,
                             const unsigned int column_y  = 2,
    ...
    GnuplotHL& plot_xy_err(const X &x, const Y &y, const E &dy,
                         const std::string &title = "");


    /// plot x,y,z triples: x y z
    ///   from file
    GnuplotHL& plotfile_xyz(const std::string &filename,
                          const unsigned int column_x = 1,
                          const unsigned int column_y = 2,
    ...
    GnuplotHL& plot_slope(const double a,
                        const double b,
                        const std::string &title = "");
    ...
    GnuplotHL& plot_equation(const std::string &equation,
                           const std::string &title = "");
    ...
    GnuplotHL& plot_equation3d(const std::string &equation,
                             const std::string &title = "");


    /// plot image
    GnuplotHL& plot_image(const unsigned char *ucPicBuf,
    ...
    /// \return ---
    //----------------------------------------------------------------------------------
    inline GnuplotHL& replot(void){if (nplots > 0) cmd("replot");return *this;};

    /// resets a gnuplot session (next plot will erase previous ones)
    GnuplotHL& reset_plot();
...
//
int GnuplotHL::tmpfile_num = 0;

#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
std::string GnuplotHL::m_sGNUPlotFileName = "pgnuplot.exe";
std::string GnuplotHL::m_sGNUPlotPath = "C:/program files/gnuplot/bin/";
#elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
std::string GnuplotHL::m_sGNUPlotFileName = "gnuplot";
std::string GnuplotHL::m_sGNUPlotPath = "/usr/local/bin/";
#endif

#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
std::string GnuplotHL::terminal_std = "windows";
#elif ( defined(unix) || defined(__unix) || defined(__unix__) ) && !defined(__APPLE__)
std::string GnuplotHL::terminal_std = "x11";
#elif defined(__APPLE__)
std::string GnuplotHL::terminal_std = "aqua";
#endif
...
//
inline GnuplotHL::GnuplotHL(const std::string &style)
...
//
inline GnuplotHL::GnuplotHL(const std::vector<double> &x,
                 const std::string &title,
...
//
template<typename X>
GnuplotHL& GnuplotHL::plot_x(const X& x, const std::string &title)
{
    if (x.size() == 0)
    {
        throw GnuplotHLException("std::vector too small");
        return *this;
    }
...
//
template<typename X, typename Y>
GnuplotHL& GnuplotHL::plot_xy(const X& x, const Y& y, const std::string &title)
{
    if (x.size() == 0 || y.size() == 0)
    {
        throw GnuplotHLException("std::vectors too small");
        return *this;
    }

    if (x.size() != y.size())
    {
        throw GnuplotHLException("Length of the std::vectors differs");
        return *this;
    }
...
///
template<typename X, typename Y, typename E>
GnuplotHL& GnuplotHL::plot_xy_err(const X &x,
                              const Y &y,
                              const E &dy,
                              const std::string &title)
{
...
//
template<typename X, typename Y, typename Z>
GnuplotHL& GnuplotHL::plot_xyz(const X &x,
                           const Y &y,
                           const Z &z,
                           const std::string &title)
{
...
//------------------------------------------------------------------------------
//
// define static member function: set GnuplotHL path manual
//   for windows: path with slash '/' not backslash '\'
//
bool GnuplotHL::set_GNUPlotPath(const std::string &path)
{

    std::string tmp = path + "/" + GnuplotHL::m_sGNUPlotFileName;


#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
    if ( GnuplotHL::file_exists(tmp,0) ) // check existence
#elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
    if ( GnuplotHL::file_exists(tmp,1) ) // check existence and execution permission
#endif
    {
        GnuplotHL::m_sGNUPlotPath = path;
        return true;
    }
    else
    {
        GnuplotHL::m_sGNUPlotPath.clear();
        return false;
    }
}
...
//  defaults: Windows - win, Linux - x11, Mac - aqua
//
void GnuplotHL::set_terminal_std(const std::string &type)
{
#if defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
    if (type.find("x11") != std::string::npos && getenv("DISPLAY") == NULL)
    {
        throw GnuplotHLException("Can't find DISPLAY variable");
    }
#endif


    GnuplotHL::terminal_std = type;
    return;
}
...
//  remove_tmpfiles();
    ...
    if (pclose(gnucmd) == -1)
#endif
        throw GnuplotHLException("Problem closing communication to gnuplot");
}
...
// Resets a gnuplot session (next plot will erase previous ones)
//
GnuplotHL& GnuplotHL::reset_plot()
{
//  remove_tmpfiles();
...
//
GnuplotHL& GnuplotHL::set_style(const std::string &stylestr)
{
...
//
GnuplotHL& GnuplotHL::set_smooth(const std::string &stylestr)
{
...
//
GnuplotHL& GnuplotHL::showonscreen()
{
    cmd("set output");
    cmd("set terminal " + GnuplotHL::terminal_std);
...
//
GnuplotHL& GnuplotHL::savetops(const std::string &filename)
{
...
// Switches legend on
//
GnuplotHL& GnuplotHL::set_legend(const std::string &position)
{
    std::ostringstream cmdstr;
...
//
GnuplotHL& GnuplotHL::set_xlogscale(const double base)
{
    std::ostringstream cmdstr;
...
//
GnuplotHL& GnuplotHL::set_ylogscale(const double base)
{
    std::ostringstream cmdstr;
...
//
GnuplotHL& GnuplotHL::set_zlogscale(const double base)
{
    std::ostringstream cmdstr;
...
// scales the size of the points used in plots
//
GnuplotHL& GnuplotHL::set_pointsize(const double pointsize)
{
    std::ostringstream cmdstr;
...
//
GnuplotHL& GnuplotHL::set_samples(const int samples)
{
    std::ostringstream cmdstr;
...
// set isoline density (grid) for plotting functions as surfaces
//
GnuplotHL& GnuplotHL::set_isosamples(const int isolines)
{
    std::ostringstream cmdstr;
...
GnuplotHL& GnuplotHL::set_contour(const std::string &position)
{
...
//
// set the xlabel
GnuplotHL& GnuplotHL::set_xlabel(const std::string &label)
{
    std::ostringstream cmdstr;
...
// set the ylabel
//
GnuplotHL& GnuplotHL::set_ylabel(const std::string &label)
{
    std::ostringstream cmdstr;
...
// set the zlabel
//
GnuplotHL& GnuplotHL::set_zlabel(const std::string &label)
{
    std::ostringstream cmdstr;
...
//
// set the xrange
GnuplotHL& GnuplotHL::set_xrange(const double iFrom,
                             const double iTo)
{
    std::ostringstream cmdstr;
...
// set the yrange
//
GnuplotHL& GnuplotHL::set_yrange(const double iFrom,
                             const double iTo)
{
    std::ostringstream cmdstr;
...
// set the zrange
//
GnuplotHL& GnuplotHL::set_zrange(const double iFrom,
                             const double iTo)
{
    std::ostringstream cmdstr;
...
//
GnuplotHL& GnuplotHL::set_cbrange(const double iFrom,
                              const double iTo)
{
    std::ostringstream cmdstr;
...
//
GnuplotHL& GnuplotHL::plot_slope(const double a,
                             const double b,
                             const std::string &title)
{
    std::ostringstream cmdstr;
...
//
GnuplotHL& GnuplotHL::plot_equation(const std::string &equation,
                                const std::string &title)
{
    std::ostringstream cmdstr;
    //
...
//
GnuplotHL& GnuplotHL::plot_equation3d(const std::string &equation,
                                  const std::string &title)
{
    std::ostringstream cmdstr;
    //
...
//
GnuplotHL& GnuplotHL::plotfile_x(const std::string &filename,
...
//
GnuplotHL& GnuplotHL::plotfile_xy(const std::string &filename,
...
//
GnuplotHL& GnuplotHL::plotfile_xy_err(const std::string &filename,
                                  const unsigned int column_x,
                                  const unsigned int column_y,
...
//
GnuplotHL& GnuplotHL::plotfile_xyz(const std::string &filename,
                               const unsigned int column_x,
                               const unsigned int column_y,
...
//
GnuplotHL& GnuplotHL::plot_image(const unsigned char * ucPicBuf,
                             const unsigned int iWidth,
                             const unsigned int iHeight,
                             const std::string &title)
{
...
//
GnuplotHL& GnuplotHL::cmd(const std::string &cmdstr)
{
    if( !(valid) )
    {
        return *this;
...
void GnuplotHL::init()
{
    ...
    if (!GnuplotHL::get_program_path())
    {
        valid = false;
        throw GnuplotHLException("Can't find gnuplot");
    }
    ...
    // open pipe
    //
    std::string tmp = GnuplotHL::m_sGNUPlotPath + "/" + 
        GnuplotHL::m_sGNUPlotFileName;
    ...
    {
        valid = false;
        throw GnuplotHLException("Couldn't open connection to gnuplot");
    }
...
//
bool GnuplotHL::get_program_path()
{
    //
    // first look in m_sGNUPlotPath for GnuplotHL
    //
    std::string tmp = GnuplotHL::m_sGNUPlotPath + "/" + 
        GnuplotHL::m_sGNUPlotFileName;
    ...
    //
    // second look in PATH for GnuplotHL
    //
    char *path;
    ...
    if (path == NULL)
    {
        throw GnuplotHLException("Path is not set");
        return false;
    }
    else
    {
        ...
        // scan list for GnuplotHL program files
        for (std::list<std::string>::const_iterator i = ls.begin(); 
                i != ls.end(); ++i)
        {
            tmp = (*i) + "/" + GnuplotHL::m_sGNUPlotFileName;
#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
            if ( GnuplotHL::file_exists(tmp,0) ) // check existence
#elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
            if ( GnuplotHL::file_exists(tmp,1) ) // check existence and execution permission
#endif
            {
                GnuplotHL::m_sGNUPlotPath = *i; // set m_sGNUPlotPath
                return true;
            }
        }

        tmp = "Can't find gnuplot neither in PATH nor in \"" + 
            GnuplotHL::m_sGNUPlotPath + "\"";
        throw GnuplotHLException(tmp);
...
// check if file exists
//
bool GnuplotHL::file_exists(const std::string &filename, int mode)
{
    if ( mode < 0 || mode > 7)
    {
        throw std::runtime_error("In function \"GnuplotHL::file_exists\": mode\
...
bool GnuplotHL::file_available(const std::string &filename){
    std::ostringstream except;
    if( GnuplotHL::file_exists(filename,0) ) // check existence
    {
        if( !(GnuplotHL::file_exists(filename,4)) ){// check read permission
            except << "No read permission for File \"" << filename << "\"";
            throw GnuplotHLException( except.str() );
            return false;
        }
    }
    else{
...
//
std::string GnuplotHL::create_tmpfile(std::ofstream &tmp)
{
    ...
    //
    if (GnuplotHL::tmpfile_num == GP_MAX_TMP_FILES - 1)
    {
        std::ostringstream except;
