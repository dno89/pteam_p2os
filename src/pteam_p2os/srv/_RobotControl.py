...
class RobotControlRequest(genpy.Message):
  _md5sum = "b81443d0db58f2178ec4ad98a5e09b60"
...
"""
  __slots__ = ['angular_speed','angular_speed_set','linear_speed','linear_speed_set','gripper_move_down','gripper_move_set']
  _slot_types = ['float32','bool','float32','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       angular_speed,angular_speed_set,linear_speed,linear_speed_set,gripper_move_down,gripper_move_set
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_fBf3B.pack(_x.angular_speed, _x.angular_speed_set, _x.linear_speed, _x.linear_speed_set, _x.gripper_move_down, _x.gripper_move_set))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.angular_speed, _x.angular_speed_set, _x.linear_speed, _x.linear_speed_set, _x.gripper_move_down, _x.gripper_move_set,) = _struct_fBf3B.unpack(str[start:end])
...
_struct_fBf3B = struct.Struct("<fBf3B")
